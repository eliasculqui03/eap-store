<div>
        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-4 md:grid-cols-2 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    ...
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Compre una amplia variedad de productos
                    ...
                    <div class="grid grid-cols-2 mt-6 lg:mt-10 gap-x-5">
                        ...
                        <div class="py-5">
                            ...
                            <p class="mt-3 text-sm text-gray-800 dark:text-gray-200">
                                <span class="font-bold">4.6</span> /5 - de 12k reseñas
                            </p>
                        ...
                        <div class="py-5">
                            ...
                            <p class="mt-3 text-sm text-gray-800 dark:text-gray-200">
                                <span class="font-bold">4.8</span> /5 - de 5k reseñas
                            </p>
        ...
        <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
                ...
                @foreach ($marcas as $marca)
                    <div wire:key="{{ $marca->id }}" class="bg-white rounded-lg shadow-md dark:bg-gray-800">
    ...
    {{-- Fin de la section de ctaegoria --}}


    {{-- Inicio de la section de review de clientes --}}
    ...
    {{-- Fin de la section de review de clientes --}}
