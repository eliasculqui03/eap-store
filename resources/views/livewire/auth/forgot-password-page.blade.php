            ...
            <div class="bg-white border border-gray-200 shadow-sm mt-7 rounded-xl dark:bg-gray-800 dark:border-gray-700">
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">¿Has olvidado tu contraseña?
                        </h1>
                    ...
                    <div class="mt-5">
                        ...
                        <form wire:submit.prevent='guardar'>
                            ...
                            @if (session('success'))
                                <div class="p-4 mb-4 text-sm text-white bg-teal-600 rounded-lg" role="alert">
                                    {{ session('success') }}
                                </div>
                            @endif
                            <div class="grid gap-y-4">
                                ...
                                <!-- End Form Group -->
                                <button type="submit"
                                    class="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-semibold text-white bg-blue-600 border border-transparent rounded-lg gap-x-2 hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Restablecer
                                    contraseña</button>
                            </div>
                        </form>
                        <!-- End Form -->
